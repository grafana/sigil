...
import { ClaudeCodeLogo, CopilotLogo, CursorLogo } from '../landing/IdeLogos';
import {
...
function renderIdeActionLogo(ide: InstrumentationPromptIde): React.ReactNode {
  if (ide === 'cursor') {
...
function getStyles(theme: GrafanaTheme2) {
  return {
    panel: css({
      ...
      background: 'color-mix(in srgb, var(--tutorial-secondary) 10%, transparent)',
      display: 'grid',
