...
export function ClaudeCodeLogo({ size = 28 }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" role="img" aria-label="Claude Code logo">
      ...
      <path d="M12 10.8C10.2 10.8 8.8 12.2 8.8 14C8.8 15.8 10.2 17.2 12 17.2" fill="none" stroke="#2A1F42" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M16 10.8C17.8 10.8 19.2 12.2 19.2 14C19.2 15.8 17.8 17.2 16 17.2" fill="none" stroke="#2A1F42" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function CopilotLogo({ size = 28 }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" role="img" aria-label="Copilot logo">
      ...
      <path d="M8.5 15C8.5 11.9 11 9.4 14 9.4C17 9.4 19.5 11.9 19.5 15V16.3C19.5 18.2 17.9 19.8 16 19.8H12C10.1 19.8 8.5 18.2 8.5 16.3V15Z" fill="url(#copilotGradient)" />
