...
const PIPELINE_SPARKS: PipelineSpark[] = [
  { size: 3, durationSec: 0.82, delaySec: -0.04, lanePct: 6, startXPct: 4, endXPct: 28, startOpacity: 0.02, curveA: -8, curveB: 14, curveC: -6, curveD: 18, curveE: -12, opacity: 0.95 },
  { size: 2, durationSec: 1.24, delaySec: -0.14, lanePct: 12, startXPct: 62, endXPct: 88, startOpacity: 0.01, curveA: 20, curveB: -24, curveC: 16, curveD: -10, curveE: 22, opacity: 0.78 },
  { size: 4, durationSec: 0.9, delaySec: -0.26, lanePct: 18, startXPct: 19, endXPct: 53, startOpacity: 0.03, curveA: -12, curveB: 18, curveC: -11, curveD: 7, curveE: -16, opacity: 0.9 },
  { size: 2, durationSec: 1.3, delaySec: -0.38, lanePct: 24, startXPct: 83, endXPct: 57, startOpacity: 0.02, curveA: 24, curveB: -14, curveC: 18, curveD: -22, curveE: 9, opacity: 0.8 },
  { size: 3, durationSec: 0.96, delaySec: -0.52, lanePct: 30, startXPct: 35, endXPct: 76, startOpacity: 0.03, curveA: -9, curveB: 21, curveC: -18, curveD: 12, curveE: -7, opacity: 0.86 },
  { size: 2, durationSec: 1.08, delaySec: -0.64, lanePct: 36, startXPct: 71, endXPct: 44, startOpacity: 0.01, curveA: 14, curveB: -12, curveC: 9, curveD: -19, curveE: 13, opacity: 0.83 },
  { size: 4, durationSec: 0.88, delaySec: -0.78, lanePct: 42, startXPct: 8, endXPct: 37, startOpacity: 0.02, curveA: -17, curveB: 8, curveC: -23, curveD: 19, curveE: -10, opacity: 0.93 },
  { size: 3, durationSec: 1.18, delaySec: -0.9, lanePct: 48, startXPct: 56, endXPct: 92, startOpacity: 0.03, curveA: 22, curveB: -18, curveC: 11, curveD: -7, curveE: 24, opacity: 0.82 },
  { size: 2, durationSec: 0.86, delaySec: -1.02, lanePct: 54, startXPct: 27, endXPct: 11, startOpacity: 0.01, curveA: -10, curveB: 12, curveC: -8, curveD: 16, curveE: -15, opacity: 0.88 },
  { size: 4, durationSec: 1.12, delaySec: -1.16, lanePct: 60, startXPct: 91, endXPct: 65, startOpacity: 0.03, curveA: 18, curveB: -26, curveC: 20, curveD: -13, curveE: 11, opacity: 0.91 },
  { size: 2, durationSec: 1.22, delaySec: -1.28, lanePct: 66, startXPct: 14, endXPct: 49, startOpacity: 0.02, curveA: -15, curveB: 9, curveC: -14, curveD: 23, curveE: -6, opacity: 0.79 },
  { size: 3, durationSec: 0.8, delaySec: -1.42, lanePct: 72, startXPct: 47, endXPct: 73, startOpacity: 0.03, curveA: 11, curveB: -13, curveC: 8, curveD: -21, curveE: 17, opacity: 0.92 },
  { size: 4, durationSec: 1.04, delaySec: -1.56, lanePct: 78, startXPct: 76, endXPct: 39, startOpacity: 0.02, curveA: -22, curveB: 17, curveC: -12, curveD: 9, curveE: -24, opacity: 0.9 },
  { size: 2, durationSec: 1.16, delaySec: -1.7, lanePct: 84, startXPct: 5, endXPct: 24, startOpacity: 0.01, curveA: 14, curveB: -10, curveC: 23, curveD: -18, curveE: 12, opacity: 0.81 },
  { size: 3, durationSec: 0.92, delaySec: -1.84, lanePct: 90, startXPct: 64, endXPct: 52, startOpacity: 0.03, curveA: -11, curveB: 20, curveC: -17, curveD: 15, curveE: -9, opacity: 0.89 },
  { size: 2, durationSec: 1.28, delaySec: -1.98, lanePct: 95, startXPct: 39, endXPct: 86, startOpacity: 0.01, curveA: 21, curveB: -17, curveC: 13, curveD: -25, curveE: 19, opacity: 0.77 },
];
...
const connectorSwarmTravel = keyframes({
  ...
  '90%': { opacity: 0.25 },
  '100%': { left: 'var(--spark-end-x, calc(100% - 2px))', top: 'var(--spark-lane)', opacity: 0, transform: 'translateY(-50%) scale(0.6)' },
});
