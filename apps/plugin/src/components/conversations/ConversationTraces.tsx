...
export function buildTraceSpans(traceID: string, payload: unknown): Array<Omit<TraceSpan, 'row'>> {
...
export function layoutSpans(rawSpans: Array<Omit<TraceSpan, 'row'>>): { rowCount: number; spans: TraceSpan[] } {
