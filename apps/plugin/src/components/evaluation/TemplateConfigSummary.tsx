...
import type { EvalOutputKey, EvaluatorKind } from '../../evaluation/types';
      ...
      {kind === 'llm_judge' && (
        <>
          ...
          <Field label="User prompt">
            <textarea className={styles.readonlyTextarea} value={String(config.user_prompt ?? '')} readOnly rows={3} />
          </Field>
          <Stack direction="row" gap={2}>
