...
const ConversationChatPage = React.lazy(() => import('../pages/ConversationChatPage'));
...
export default function App(_props: AppRootProps) {
  ...
  const isConversationsBrowserRoute = new RegExp(`(^|/)${ROUTES.Conversations}(/[^/]+/(view|chat))?/?$`).test(
    location.pathname
  );
