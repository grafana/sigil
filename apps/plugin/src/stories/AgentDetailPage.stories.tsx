    ...
    tools: [
      {
        ...
        description: 'Query incidents by service and severity. Returns matching incidents with their current status, severity level, and assigned responder.',
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"service":{"type":"string","description":"Service name to filter by"},"severity":{"type":"string","enum":["critical","high","medium","low"]},"limit":{"type":"number","default":10}},"required":["service"]}',
        token_estimate: 128,
      },
      {
        name: 'fetch_runbook',
      ...
      },
      {
        ...
        description: 'Discover and query Prometheus time-series metrics. Metrics provide quantitative measurements (CPU, memory, request rates, errors). Essential for monitoring and performance analysis.',
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"datasource_uid":{"type":"string"},"query_type":{"type":"string","enum":["instant","range"]},"operation":{"type":"string"},"metric_patterns":{"type":"array","items":{"type":"string"}},"label_name":{"type":"string"},"start":{"type":"string"},"end":{"type":"string"}},"required":["datasource_uid","operation"]}',
        token_estimate: 1577,
      },
      {
        ...
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"title":{"type":"string"},"panels":{"type":"array"}},"required":["title"]}',
        token_estimate: 137,
      },
      {
        ...
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"action":{"type":"string","enum":["create","update","delete"]},"rule":{"type":"object"}},"required":["action"]}',
        token_estimate: 563,
      },
      {
        ...
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"datasource_uid":{"type":"string"},"query":{"type":"string"},"start":{"type":"string"},"end":{"type":"string"},"limit":{"type":"number"}},"required":["datasource_uid","query"]}',
        token_estimate: 1577,
      },
      {
        name: 'grafana_search',
        ...
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"query":{"type":"string"},"type":{"type":"string","enum":["dash-db","dash-folder"]}},"required":["query"]}',
        token_estimate: 134,
      },
      {
        ...
        type: 'function',
        input_schema_json: '{"type":"object","properties":{"entity_type":{"type":"string"},"entity_id":{"type":"string"}},"required":["entity_type","entity_id"]}',
        token_estimate: 441,
      },
    ],
    models: [
