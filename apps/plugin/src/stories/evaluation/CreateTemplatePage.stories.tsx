...
const mockDataSource: EvaluationDataSource = {
  ...
  saveConversation: async () => ({ tenant_id: '', saved_id: '', conversation_id: '', name: '', source: 'telemetry' as const, tags: {}, saved_by: '', created_at: '', updated_at: '' }),
  getSavedConversation: async () => ({ tenant_id: '', saved_id: '', conversation_id: '', name: '', source: 'telemetry' as const, tags: {}, saved_by: '', created_at: '', updated_at: '' }),
  deleteSavedConversation: async () => {},
  createManualConversation: async () => ({ tenant_id: '', saved_id: '', conversation_id: '', name: '', source: 'manual' as const, tags: {}, saved_by: '', created_at: '', updated_at: '' }),
};
