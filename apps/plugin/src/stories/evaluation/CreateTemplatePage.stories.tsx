...
const mockDataSource: EvaluationDataSource = {
  ...
  saveConversation: async () => ({
    tenant_id: '', saved_id: '', conversation_id: '', name: '',
    source: 'telemetry' as const, tags: {}, saved_by: '',
    created_at: '', updated_at: '', generation_count: 0, total_tokens: 0, agent_names: [],
  }),
  ...
  createManualConversation: async () => ({
    tenant_id: '', saved_id: '', conversation_id: '', name: '',
    source: 'manual' as const, tags: {}, saved_by: '',
    created_at: '', updated_at: '', generation_count: 0, total_tokens: 0, agent_names: [],
  }),
