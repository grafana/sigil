...
export const WithInvertedIncrease = () => (
  <Template label="Error Rate" value={5.2} unit="percent" loading={false} prevValue={3.1} prevLoading={false} invertChange />
);

export const WithInvertedDecrease = () => (
  <Template label="Avg Latency (P95)" value={0.8} unit="s" loading={false} prevValue={1.2} prevLoading={false} invertChange />
);
...
export const StatsRow = () => (
  <div style={{ display: 'flex', gap: 32, padding: 16 }}>
    ...
    <TopStat label="Avg Latency (P95)" value={0.45} unit="s" loading={false} prevValue={0.52} prevLoading={false} invertChange />
    <TopStat label="Error Rate" value={2.3} unit="percent" loading={false} prevValue={1.8} prevLoading={false} invertChange />
    <TopStat label="Total Tokens" value={89000} unit="short" loading={false} prevValue={75000} prevLoading={false} />
    <TopStat label="Total Cost" value={12.5} unit="currencyUSD" loading={false} prevValue={14.2} prevLoading={false} invertChange />
  </div>
);
