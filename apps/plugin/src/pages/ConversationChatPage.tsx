...
import { buildConversationChatRoute, ROUTES } from '../constants';

export type ConversationChatPageProps = {
...
const getStyles = (theme: GrafanaTheme2) => ({
  pageContainer: css({
    label: 'conversationChatPage-pageContainer',
    position: 'absolute',
    inset: 0,
    display: 'grid',
  ...
  summarySection: css({
    label: 'conversationChatPage-summarySection',
  ...
  controlsRow: css({
    label: 'conversationChatPage-controlsRow',
    display: 'flex',
  ...
  statsGrid: css({
    label: 'conversationChatPage-statsGrid',
    display: 'flex',
  ...
  statTile: css({
    label: 'conversationChatPage-statTile',
  ...
  statLabel: css({
    label: 'conversationChatPage-statLabel',
  ...
  statValue: css({
    label: 'conversationChatPage-statValue',
    fontSize: theme.typography.h3.fontSize,
    fontWeight: theme.typography.fontWeightMedium,
  }),
  statValueRow: css({
    label: 'conversationChatPage-statValueRow',
    display: 'flex',
    alignItems: 'baseline',
  ...
  statTrend: css({
    label: 'conversationChatPage-statTrend',
    fontSize: theme.typography.bodySmall.fontSize,
    color: theme.colors.text.secondary,
  }),
  statTrendUp: css({
    label: 'conversationChatPage-statTrendUp',
    color: theme.colors.success.main,
  }),
  statTrendDown: css({
    label: 'conversationChatPage-statTrendDown',
    color: theme.colors.error.main,
  }),
  errorAlert: css({
    label: 'conversationChatPage-errorAlert',
    margin: 0,
    border: 'none',
  ...
  layout: css({
    label: 'conversationChatPage-layout',
    display: 'grid',
  ...
  layoutWithSelection: css({
    label: 'conversationChatPage-layoutWithSelection',
  ...
  leftPanel: css({
    label: 'conversationChatPage-leftPanel',
    minHeight: 0,
    overflow: 'hidden',
    display: 'flex',
    flexDirection: 'column' as const,
  ...
  middlePanel: css({
    label: 'conversationChatPage-middlePanel',
    minHeight: 0,
    overflow: 'hidden',
    minWidth: 0,
    width: '100%',
  ...
  detailPanel: css({
    label: 'conversationChatPage-detailPanel',
    minHeight: 0,
  ...
  emptySelection: css({
    label: 'conversationChatPage-emptySelection',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    height: '100%',
  ...
  detailPlaceholder: css({
    label: 'conversationChatPage-detailPlaceholder',
    flex: 1,
    minHeight: 0,
  ...
  detailJson: css({
    label: 'conversationChatPage-detailJson',
    margin: 0,
  ...
  pageSpinner: css({
    label: 'conversationChatPage-pageSpinner',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    flex: 1,
...
export default function ConversationChatPage(props: ConversationChatPageProps) {
  ...
  const onSelectConversation = useCallback(
    (conversationID: string) => {
      if (conversationID.length === 0) {
        ...
        void navigate(buildAppPath(buildConversationChatRoute(conversationID)), { replace: true });
      }
    },
