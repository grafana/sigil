...
import { buildToolMetricFilters, buildToolConversationFilters } from '../dashboard/toolRuntime';
import { buildAnalyticsUrl, buildConversationsUrl } from '../dashboard/url';
...
export default function ToolAnalyticsPage({
  ...
  const metricFilters = useMemo(() => buildToolMetricFilters(filters, toolName), [filters, toolName]);
  const conversationFilters = useMemo(() => buildToolConversationFilters(filters, toolName), [filters, toolName]);
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>
            Existing MVP tool runtime analytics built from `execute_tool` metrics and tool-scoped conversation search.
          </p>
        </div>
        <Stack direction="row" gap={1}>
          <LinkButton href={buildAnalyticsUrl(timeRange, filters)} variant="secondary" size="sm">
            Back to analytics
          </LinkButton>
