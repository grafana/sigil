"""Shared handler logic for Sigil framework callback handlers."""
...
class SigilFrameworkHandlerBase:
    """Base handler with all shared generation-recording logic.

    Subclasses must set ``_framework_name`` and
    ``_framework_instrumentation_name`` as class attributes.
    """

    _framework_name: str = ""
    _framework_source: str = "handler"
    _framework_language: str = "python"
    _framework_instrumentation_name: str = ""
...
class SigilSyncCallbackMixin(SigilFrameworkHandlerBase):
    """Mixin that maps LangChain sync callback signatures to shared handler methods."""
...
class SigilAsyncCallbackMixin(SigilFrameworkHandlerBase):
    """Mixin that maps LangChain async callback signatures to shared handler methods."""
