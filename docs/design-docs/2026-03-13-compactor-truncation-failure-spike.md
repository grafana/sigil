...
- `SIGIL_COMPACTOR_TRUNCATE_INTERVAL` defaults to 5 minutes in
  [sigil/internal/config/config.go](../../sigil/internal/config/config.go#L24)
...
- [sigil/internal/storage/compactor/service.go](../../sigil/internal/storage/compactor/service.go#L439)
...
- [sigil/internal/storage/mysql/retry.go](../../sigil/internal/storage/mysql/retry.go#L64)
...
1. The observed failures still terminate at
   [compaction.go](../../sigil/internal/storage/mysql/compaction.go#L68),
