...
set_default_env() {
  ...
  export SIGIL_TRAFFIC_TRACE_HTTP_ENDPOINT="${SIGIL_TRAFFIC_TRACE_HTTP_ENDPOINT:-http://sigil:4318/v1/traces}"
  export SIGIL_TRAFFIC_TRACE_GRPC_ENDPOINT="${SIGIL_TRAFFIC_TRACE_GRPC_ENDPOINT:-sigil:4317}"
}
